...
(function() {
  ...
  set_symbols = function(symlist) {
    ...
    for (i = l1 = 0, ref2 = symlist.symbols.length; 0 <= ref2 ? l1 < ref2 : l1 > ref2; i = 0 <= ref2 ? ++l1 : --l1) {
      results.push(set_binding(symlist.symbols[i], symlist.binding[i]));
    }
    return results;
  };

...
(function() {
  ...
  findDependenciesInScript = function(stringToBeParsed, dontGenerateCode) {
    var ae, af, ag, ah, aj, al, allReturnedLatexStrings, allReturnedPlainStrings, am, ao, ap, bodyForReadableSummaryOfGeneratedCode, cacheKey, cacheMissPenalty, currentStateHash, cyclesDescriptions, deQuotedDep, dependencyInfo, eachDependency, error, frozen, generatedBody, generatedCode, i, indexOfEachReplacement, indexOfPartRemainingToBeParsed, inited, key, len, len1, len2, len3, len4, len5, len6, len7, n, newUserSymbol, origPrintMode, originalUserSymbol, parameters, possiblyCached, readableSummaryOfGeneratedCode, recursedDependencies, ref2, replacementsFrom, replacementsTo, scriptEvaluation, stringToBeRun, testableString, timeStartFromAlgebra, toBeFrozen, toBePrinted, totalTime, userVariablesMentioned, value, variablesWithCycles;
    if (DEBUG) {
  ...
  get_symbols = function() {
    var ae, bind, i, ref2, sym_count, symb, symlist;
    i = 0;
    sym_count = 0;
    symb = [];
    bind = [];
  ...
  set_symbols = function(symlist) {
    var ae, i, ref2;
    i = 0;
    for (i = ae = 0, ref2 = symlist.symbols.length; 0 <= ref2 ? ae < ref2 : ae > ref2; i = 0 <= ref2 ? ++ae : --ae) {
  ...
  set_symbols_from_strings = function(symlist) {
    var ae, current_symbol, i, ref2;
    i = 0;
    for (i = ae = 0, ref2 = symlist.length; 0 <= ref2 ? ae < ref2 : ae > ref2; i = 0 <= ref2 ? ++ae : --ae) {

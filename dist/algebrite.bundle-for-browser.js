...
(function() {
  ...
  print_DEFINT_latex = function(p) {
    var functionBody, i, i1, numberOfIntegrals, originalIntegral, ref1, results, theIntegral, theVariable;
  ...
  Eval_product = function() {
    ...
    p4 = get_binding(p6);
    push_integer(1);
    for (i = i1 = ref1 = j, ref2 = k; ref1 <= ref2 ? i1 <= ref2 : i1 >= ref2; i = ref1 <= ref2 ? ++i1 : --i1) {
      push_integer(i);
      p5 = pop();
      set_binding(p6, p5);
      push(p1);
  ...
  quickfactor = function() {
    ...
    n = tos - h;
    stackIndex = h;
    for (i = i1 = 0, ref1 = n; i1 < ref1; i = i1 += 2) {
  ...
  divpoly = function() {
    var dividend, divisor, h, i, i1, m, n, ref1, x;
    h = 0;
    i = 0;
    m = 0;
    n = 0;
  ...
  hasImaginaryCoeff = function(k) {
    var h, i, i1, imaginaryCoefficients, ref1;
    imaginaryCoefficients = false;
    h = tos;
    for (i = i1 = ref1 = k; i1 > 0; i = i1 += -1) {
  ...
  isSimpleRoot = function(k) {
    var h, i, i1, isSimpleRootPolynomial, ref1;
    if (k > 2) {
  ...
  normalisedCoeff = function() {
    var divideBy, i, i1, j1, k, miniStack, ref1, ref2;
    k = coeff();
    divideBy = stack[tos - 1];
    miniStack = [];
    for (i = i1 = 1, ref1 = k; 1 <= ref1 ? i1 <= ref1 : i1 >= ref1; i = 1 <= ref1 ? ++i1 : --i1) {
      miniStack.push(pop());
    }
    for (i = j1 = ref2 = k - 1; ref2 <= 0 ? j1 <= 0 : j1 >= 0; i = ref2 <= 0 ? ++j1 : --j1) {
      push(miniStack[i]);
      push(divideBy);
      divide();
    }
  ...
  roots = function() {
    var h, i, i1, k, lastCoeff, leadingCoeff, n, ref1;
    h = 0;
    i = 0;
    n = 0;
    save();
  ...
  getSimpleRoots = function(n, leadingCoeff, lastCoeff) {
    var aSol, commonPart, i1, j1, ref1, ref2, rootsOfOne;
    if (DEBUG) {
    ...
    commonPart = pop();
    if (n % 2 === 0) {
      for (rootsOfOne = i1 = 1, ref1 = n; i1 <= ref1; rootsOfOne = i1 += 2) {
        push(commonPart);
        push_integer(-1);
      ...
      for (rootsOfOne = j1 = 1, ref2 = n; 1 <= ref2 ? j1 <= ref2 : j1 >= ref2; rootsOfOne = 1 <= ref2 ? ++j1 : --j1) {
        push(commonPart);
        push_integer(-1);
        push_rational(rootsOfOne, n);
        power();
    ...
    if (n === 4 || n === 5) {
      ...
      if (n === 5) {
        ...
        if (iszero(p4) && iszero(p6) && !iszero(p5) && !iszero(p7)) {
          ...
          for (i1 = 0, len = ref1.length; i1 < len; i1++) {
            eachSolution = ref1[i1];
            push(eachSolution);
            push_rational(1, 2);
            power();
            simplify();
        ...
        if (!iszero(p4)) {
          ...
          for (j1 = 0, len1 = ref2.length; j1 < len1; j1++) {
            eachSolution = ref2[j1];
            push(eachSolution);
            push(p4);
            push_integer(4);
            push(p3);
          ...
          for (l1 = 0, len2 = ref3.length; l1 < len2; l1++) {
            eachSolution = ref3[l1];
            if (DEBUG) {
              console.log("examining solution: " + eachSolution);
            }
            push(eachSolution);
  ...
  scan_stmt = function() {
    var existingDependencies, i, i1, indexOfSymbolLeftOfAssignment, j1, len, len1, symbolLeftOfAssignment;
    scan_relation();
    if (token === '=') {
      ...
      for (i1 = 0, len = symbolsRightOfAssignment.length; i1 < len; i1++) {
        i = symbolsRightOfAssignment[i1];
        if (DEBUG) {
          console.log("	" + i);
        }
      }
      ...
      for (j1 = 0, len1 = symbolsRightOfAssignment.length; j1 < len1; j1++) {
        i = symbolsRightOfAssignment[j1];
  ...
  addSymbolRightOfAssignment = function(theSymbol) {
    ...
    if (predefinedSymbolsInGlobalScope_doNotTrackInDependencies.indexOf(theSymbol) === -1 && symbolsRightOfAssignment.indexOf(theSymbol) === -1 && !skipRootVariableToBeSolved) {
      ...
      prefixVar = "";
      for (i = i1 = 1, ref1 = functionInvokationsScanningStack.length; 1 <= ref1 ? i1 < ref1 : i1 > ref1; i = 1 <= ref1 ? ++i1 : --i1) {
  ...
  scan_function_call = function() {
    var functionName, i, i1, n, p, ref1;
    if (DEBUG) {
    ...
    for (i = i1 = 0, ref1 = symbolsRightOfAssignment.length; 0 <= ref1 ? i1 <= ref1 : i1 >= ref1; i = 0 <= ref1 ? ++i1 : --i1) {
  ...
  shape = function() {
    var ai, an, i, i1, j1, ndim, ref1, ref2, t;
    i = 0;
    ndim = 0;
    t = 0;
    ai = [];
    an = [];
    for (i = i1 = 0, ref1 = MAXDIM; 0 <= ref1 ? i1 < ref1 : i1 > ref1; i = 0 <= ref1 ? ++i1 : --i1) {
      ai[i] = 0;
      an[i] = 0;
    }
    save();
  ...
  yysimfac = function(h) {
    var i, i1, j, j1, ref1, ref2, ref3, ref4;
    i = 0;
    j = 0;
    for (i = i1 = ref1 = h, ref2 = tos; ref1 <= ref2 ? i1 < ref2 : i1 > ref2; i = ref1 <= ref2 ? ++i1 : --i1) {
      p1 = stack[i];
      for (j = j1 = ref3 = h, ref4 = tos; ref3 <= ref4 ? j1 < ref4 : j1 > ref4; j = ref3 <= ref4 ? ++j1 : --j1) {
        if (i === j) {
          continue;
        }
        p2 = stack[j];
  ...
  simplify_tensor = function() {
    ...
    for (i = j1 = 0, ref2 = p1.tensor.nelem; 0 <= ref2 ? j1 < ref2 : j1 > ref2; i = 0 <= ref2 ? ++j1 : --j1) {
      push(p1.tensor.elem[i]);
      simplify();
      p2.tensor.elem[i] = pop();
    }
  ...
  take_care_of_nested_radicals = function() {
    ...
    if (equal(car(p1), symbol(POWER))) {
      ...
      if (!isminusone(exponent) && equal(car(base), symbol(ADD)) && isfraction(exponent) && (equalq(exponent, 1, 3) || equalq(exponent, 1, 2))) {
        ...
        A = firstTerm;
        push_integer(1);
        for (i1 = 0, len = commonBases.length; i1 < len; i1++) {
          i = commonBases[i1];
          push(i);
          multiply();
        }
        C = pop();
        push_integer(1);
        for (j1 = 0, len1 = termsThatAreNotPowers.length; j1 < len1; j1++) {
          i = termsThatAreNotPowers[j1];
          push(i);
          multiply();
        }
        B = pop();
        ...
        for (l1 = 0, len2 = ref1.length; l1 < len2; l1++) {
          eachSolution = ref1[l1];
        ...
        for (m1 = 0, len3 = possibleSolutions.length; m1 < len3; m1++) {
          i = possibleSolutions[m1];
          push(i);
          real();
          yyfloat();
  ...
  Eval_tensor = function() {
    var a, b, i, i1, j1, ndim, nelem, ref1, ref2;
    i = 0;
    ndim = 0;
    nelem = 0;
    if (p1.tensor.nelem !== p1.tensor.elem.length) {
    ...
    for (i = j1 = 0, ref2 = nelem; 0 <= ref2 ? j1 < ref2 : j1 > ref2; i = 0 <= ref2 ? ++j1 : --j1) {
      push(a[i]);
      Eval();
      b[i] = pop();
    }
  ...
  tensor_plus_tensor = function() {
    var a, b, c, i, i1, j1, l1, ndim, nelem, ref1, ref2, ref3;
    i = 0;
    ndim = 0;
    nelem = 0;
    save();
  ...
  d_tensor_tensor = function() {
    var a, b, c, i, i1, j, j1, l1, ndim, nelem, ref1, ref2, ref3;
    i = 0;
    j = 0;
    ndim = 0;
    nelem = 0;
    ...
    c = p3.tensor.elem;
    for (i = j1 = 0, ref2 = nelem; 0 <= ref2 ? j1 < ref2 : j1 > ref2; i = 0 <= ref2 ? ++j1 : --j1) {
      for (j = l1 = 0, ref3 = p2.tensor.nelem; 0 <= ref3 ? l1 < ref3 : l1 > ref3; j = 0 <= ref3 ? ++l1 : --l1) {
        push(a[i]);
        push(b[j]);
        derivative();
  ...
  d_scalar_tensor = function() {
    ...
    a = p2.tensor.elem;
    b = p3.tensor.elem;
    for (i = i1 = 0, ref1 = p2.tensor.nelem; 0 <= ref1 ? i1 < ref1 : i1 > ref1; i = 0 <= ref1 ? ++i1 : --i1) {
      push(p1);
      push(a[i]);
      derivative();
      b[i] = pop();
  ...
  power_tensor = function() {
    var i, i1, j1, k, n, ref1, ref2, results;
    i = 0;
    k = 0;
    n = 0;
    k = p1.tensor.ndim - 1;
    ...
    push(p1);
    results = [];
    for (i = j1 = 1, ref2 = n; 1 <= ref2 ? j1 < ref2 : j1 > ref2; i = 1 <= ref2 ? ++j1 : --j1) {
      push(p1);
      inner();
  ...
  promote_tensor = function() {
    var i, i1, j, j1, k, l1, m1, n1, ndim, nelem, ref1, ref2, ref3, ref4, ref5;
    i = 0;
    j = 0;
    k = 0;
    nelem = 0;
    ...
    p2 = p1.tensor.elem[0];
    for (i = i1 = 1, ref1 = p1.tensor.nelem; 1 <= ref1 ? i1 < ref1 : i1 > ref1; i = 1 <= ref1 ? ++i1 : --i1) {
    ...
    p3 = alloc_tensor(nelem);
    p3.tensor.ndim = ndim;
    for (i = j1 = 0, ref2 = p1.tensor.ndim; 0 <= ref2 ? j1 < ref2 : j1 > ref2; i = 0 <= ref2 ? ++j1 : --j1) {
      p3.tensor.dim[i] = p1.tensor.dim[i];
    }
    for (j = l1 = 0, ref3 = p2.tensor.ndim; 0 <= ref3 ? l1 < ref3 : l1 > ref3; j = 0 <= ref3 ? ++l1 : --l1) {
      p3.tensor.dim[i + j] = p2.tensor.dim[j];
    }
    k = 0;
    for (i = m1 = 0, ref4 = p1.tensor.nelem; 0 <= ref4 ? m1 < ref4 : m1 > ref4; i = 0 <= ref4 ? ++m1 : --m1) {
      p2 = p1.tensor.elem[i];
      for (j = n1 = 0, ref5 = p2.tensor.nelem; 0 <= ref5 ? n1 < ref5 : n1 > ref5; j = 0 <= ref5 ? ++n1 : --n1) {
  ...
  compatible = function(p, q) {
    ...
    for (i = i1 = 0, ref1 = p.tensor.ndim; 0 <= ref1 ? i1 < ref1 : i1 > ref1; i = 0 <= ref1 ? ++i1 : --i1) {
  ...
  transform = function(s, generalTransform) {
    var eachTransformEntry, firstTermSuccess, firstTermTransform, i, i1, j1, l1, len, len1, ref1, secondTermSuccess, secondTermTransform, transform_h, transformationSuccessful;
    transform_h = 0;
    save();
    p1 = null;
    p4 = pop();
    ...
    decomp(generalTransform);
    if (DEBUG) {
      for (i = i1 = 1, ref1 = tos; 1 <= ref1 ? i1 < ref1 : i1 > ref1; i = 1 <= ref1 ? ++i1 : --i1) {
        console.log("stack content at " + i + " " + stack[tos - i]);
      }
    }
    if (generalTransform) {
      for (j1 = 0, len = s.length; j1 < len; j1++) {
        eachTransformEntry = s[j1];
        if (DEBUG) {
      ...
      for (l1 = 0, len1 = s.length; l1 < len1; l1++) {
        eachTransformEntry = s[l1];
        if (DEBUG) {
          console.log("scanning table entry " + eachTransformEntry);
        }
        if (eachTransformEntry) {
  ...
  f_equals_a = function(h, generalTransform) {
    var fea_i, fea_j, i1, j1, originalexpanding, ref1, ref2, ref3, ref4;
    fea_i = 0;
    fea_j = 0;
    for (fea_i = i1 = ref1 = h, ref2 = tos; ref1 <= ref2 ? i1 < ref2 : i1 > ref2; fea_i = ref1 <= ref2 ? ++i1 : --i1) {
      ...
      for (fea_j = j1 = ref3 = h, ref4 = tos; ref3 <= ref4 ? j1 < ref4 : j1 > ref4; fea_j = ref3 <= ref4 ? ++j1 : --j1) {
  ...
  transpose = function() {
    var a, accumulator, ai, an, b, eachEntry, i, i1, innerTranspSwitch1, innerTranspSwitch2, j, j1, k, l, l1, m, m1, n1, ndim, nelem, o1, q1, ref1, ref2, ref3, ref4, ref5, ref6, ref7, t;
    i = 0;
    j = 0;
    k = 0;
    l = 0;
    ...
    if (expanding && isinnerordot(p1)) {
      ...
      for (eachEntry = j1 = ref2 = accumulator.length - 1; ref2 <= 0 ? j1 <= 0 : j1 >= 0; eachEntry = ref2 <= 0 ? ++j1 : --j1) {
    ...
    p2 = alloc_tensor(nelem);
    p2.tensor.ndim = ndim;
    for (i = l1 = 0, ref3 = ndim; 0 <= ref3 ? l1 < ref3 : l1 > ref3; i = 0 <= ref3 ? ++l1 : --l1) {
      p2.tensor.dim[i] = p1.tensor.dim[i];
    }
    ...
    a = p1.tensor.elem;
    b = p2.tensor.elem;
    for (i = m1 = 0, ref4 = ndim; 0 <= ref4 ? m1 < ref4 : m1 > ref4; i = 0 <= ref4 ? ++m1 : --m1) {
      ai[i] = 0;
      an[i] = p1.tensor.dim[i];
    }
    for (i = n1 = 0, ref5 = nelem; 0 <= ref5 ? n1 < ref5 : n1 > ref5; i = 0 <= ref5 ? ++n1 : --n1) {
      t = ai[l];
      ai[l] = ai[m];
      ai[m] = t;
      t = an[l];
      ...
      an[m] = t;
      k = 0;
      for (j = o1 = 0, ref6 = ndim; 0 <= ref6 ? o1 < ref6 : o1 > ref6; j = 0 <= ref6 ? ++o1 : --o1) {
        k = (k * an[j]) + ai[j];
      }
      t = ai[l];
      ai[l] = ai[m];
      ...
      an[m] = t;
      b[k] = a[i];
      for (j = q1 = ref7 = ndim - 1; ref7 <= 0 ? q1 <= 0 : q1 >= 0; j = ref7 <= 0 ? ++q1 : --q1) {
        if (++ai[j] < an[j]) {
          break;
        }
        ai[j] = 0;
  ...
  Eval_zero = function() {
    ...
    p1 = alloc_tensor(m);
    p1.tensor.ndim = n;
    for (i = j1 = 0, ref2 = n; 0 <= ref2 ? j1 < ref2 : j1 > ref2; i = 0 <= ref2 ? ++j1 : --j1) {
      p1.tensor.dim[i] = k[i];
    }
    return push(p1);
  };
  ...
  alloc_tensor = function(nelem) {
    ...
    for (i = i1 = 0, ref1 = nelem; 0 <= ref1 ? i1 < ref1 : i1 > ref1; i = 0 <= ref1 ? ++i1 : --i1) {
  ...
  print_it = function() {
    var accumulatedPrint, i, j1, ref2, subsetOfStack, x, y;
    i = 0;
    accumulatedPrint = "";
  ...
  init = function() {
    ...
    for (i = m1 = 0, ref3 = NSYM; 0 <= ref3 ? m1 < ref3 : m1 > ref3; i = 0 <= ref3 ? ++m1 : --m1) {
      symtab[i].k = SYM;
      binding[i] = symtab[i];
    }
    p0 = symbol(NIL);
  ...
  defn = function() {
    var definitionOfInterest, defn_i, l1, ref2, results;
    results = [];
  ...
  findDependenciesInScript = function(stringToBeParsed) {
    var allReturnedPlainStrings, bodyForReadableSummaryOfGeneratedCode, cyclesDescriptions, error, generatedBody, generatedCode, i, indexOfPartRemainingToBeParsed, inited, key, l1, len, len1, len2, len3, len4, m1, n, n1, o1, parameters, q1, readableSummaryOfGeneratedCode, recursedDependencies, scriptEvaluation, testableString, toBePrinted, value, variablesWithCycles;
    if (DEBUG) {
    ...
    for (key in symbolsDependencies) {
      ...
      for (m1 = 0, len1 = variablesWithCycles.length; m1 < len1; m1++) {
        i = variablesWithCycles[m1];
        if (DEBUG) {
          console.log("		--> cycle through " + i);
        }
      }
      for (n1 = 0, len2 = recursedDependencies.length; n1 < len2; n1++) {
        i = recursedDependencies[n1];
        if (DEBUG) {
          console.log("		" + i);
        }
        testableString += i + ", ";
      ...
      testableString += "; ";
      for (o1 = 0, len3 = cyclesDescriptions.length; o1 < len3; o1++) {
        i = cyclesDescriptions[o1];
        testableString += " " + i + ", ";
      }
      if (DEBUG) {
  ...
  run = function(stringToBeRun, generateLatex) {
    var allReturnedLatexStrings, allReturnedPlainStrings, collectedLatexResult, collectedPlainResult, error, i, indexOfPartRemainingToBeParsed, n;
  ...
  get_symbols = function() {
    var bind, i, l1, ref2, sym_count, symb, symlist;
    i = 0;
    sym_count = 0;
    symb = [];
    bind = [];
  ...
  set_symbols = function(symlist) {
    var i, l1, ref2;
    i = 0;
    for (i = l1 = 0, ref2 = symlist.symbols.length; 0 <= ref2 ? l1 < ref2 : l1 > ref2; i = 0 <= ref2 ? ++l1 : --l1) {
      set_binding(symlist.symbols[i], symlist.binding[i]);
    }
    return true;
  };

  binding_to_string = function(s, b) {
    var bString, func_array, sString, symstring;
    symstring = "";
    sString = s.toString();
    bString = b.toString();
    switch (b.k) {
  ...
  get_symbols_as_strings = function() {
    var i, l1, ref2, sym_count, symb;
    i = 0;
    sym_count = 0;
    symb = [];
    for (i = l1 = 0, ref2 = NSYM; 0 <= ref2 ? l1 < ref2 : l1 > ref2; i = 0 <= ref2 ? ++l1 : --l1) {
  ...
  set_symbols_from_strings = function(symlist) {
    var current_symbol, i, l1, ref2;
    i = 0;
    for (i = l1 = 0, ref2 = symlist.length; 0 <= ref2 ? l1 < ref2 : l1 > ref2; i = 0 <= ref2 ? ++l1 : --l1) {
